    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                half m_alpha = surfaceData.alpha;
                half4 m_color = half4(surfaceData.albedo, m_alpha);
                const half4 m_mask = surfaceData.mask;
                const half2 m_lightingUV = inputData.lightingUV;
                if (m_alpha == 0.0)
                    discard;


                #if USE_SHAPE_LIGHT_TYPE_0
                half4 shapeLight0 = SAMPLE_TEXTURE2D(_ShapeLightTexture0, sampler_ShapeLightTexture0, m_lightingUV);
            
                if (any(_ShapeLightMaskFilter0))
                {
                    half4 processedMask = (1 - _ShapeLightInvertedFilter0) * m_mask + _ShapeLightInvertedFilter0 * (1 - m_mask);
                ...
                #if USE_SHAPE_LIGHT_TYPE_1
                half4 shapeLight1 = SAMPLE_TEXTURE2D(_ShapeLightTexture1, sampler_ShapeLightTexture1, m_lightingUV);
            
                if (any(_ShapeLightMaskFilter1))
                {
                    half4 processedMask = (1 - _ShapeLightInvertedFilter1) * m_mask + _ShapeLightInvertedFilter1 * (1 - m_mask);
                ...
                #if USE_SHAPE_LIGHT_TYPE_2
                half4 shapeLight2 = SAMPLE_TEXTURE2D(_ShapeLightTexture2, sampler_ShapeLightTexture2, m_lightingUV);
            
                if (any(_ShapeLightMaskFilter2))
                {
                    half4 processedMask = (1 - _ShapeLightInvertedFilter2) * m_mask + _ShapeLightInvertedFilter2 * (1 - m_mask);
                ...
                #if USE_SHAPE_LIGHT_TYPE_3
                half4 shapeLight3 = SAMPLE_TEXTURE2D(_ShapeLightTexture3, sampler_ShapeLightTexture3, m_lightingUV);
            
                if (any(_ShapeLightMaskFilter3))
                {
                    half4 processedMask = (1 - _ShapeLightInvertedFilter3) * m_mask + _ShapeLightInvertedFilter3 * (1 - m_mask);
