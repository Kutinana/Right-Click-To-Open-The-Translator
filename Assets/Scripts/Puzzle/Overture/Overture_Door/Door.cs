...
namespace Puzzle.Overture.Door
{
    public class Door : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            LeftUp.onClick.AddListener(() => Puzzle.Instance.UpdateNumber(0, 1));
            LeftDown = transform.Find("LeftButtonDown").GetComponent<Button>();
            LeftDown.onClick.AddListener(() => Puzzle.Instance.UpdateNumber(0, -1));

            MiddleUp = transform.Find("MiddleButtonUp").GetComponent<Button>();
            MiddleUp.onClick.AddListener(() => Puzzle.Instance.UpdateNumber(1, 1));
            MiddleDown = transform.Find("MiddleButtonDown").GetComponent<Button>();
            MiddleDown.onClick.AddListener(() => Puzzle.Instance.UpdateNumber(1, -1));

            RightUp = transform.Find("RightButtonUp").GetComponent<Button>();
            RightUp.onClick.AddListener(() => Puzzle.Instance.UpdateNumber(2, 1));
            RightDown = transform.Find("RightButtonDown").GetComponent<Button>();
            RightDown.onClick.AddListener(() => Puzzle.Instance.UpdateNumber(2, -1));
        }
        ...
        private IEnumerator OnMouseDown()
        {
            ...
            while (Input.GetMouseButton(0) && Puzzle.Instance.IsUnlocked)
            {
